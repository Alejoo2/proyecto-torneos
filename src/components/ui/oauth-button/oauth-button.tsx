...
const DiscordIcon = () => (
  <svg className="w-5 h-5 shrink-0" viewBox="0 0 24 24" fill="#5865F2" xmlns="http://www.w3.org/2000/svg">
...
export function OAuthButton({ 
  ...
  return (
    <button
      className={cn(oauthButtonVariants({ provider, isLoading }), className)}
